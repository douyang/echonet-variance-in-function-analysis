...
def segment(inp):
    ...
    imagePath = "testing/segmented_img.png"
    im.save(imagePath)
    ...
    volume_data = "Volume: " + str(volumes[0])

    return image, volume_data
...
gr.Interface(segment, i, [o, "text"], examples=examples, allow_flagging=False,
