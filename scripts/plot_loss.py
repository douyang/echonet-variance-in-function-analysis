...
def main():
    ...
    for pretrained in [True]:
        for (model, color) in zip(["r2plus1d_18", "r3d_18", "mc3_18"], matplotlib.colors.TABLEAU_COLORS):
            loss = load("/Users/ishan/Documents/Stanford/EchoData/output/video/r2plus1d_18_32_1_pretrained/scripts/verbose_normalizedlargeindex.csv")
    ...
    for (model, color) in zip(["Cardiac Function Evaluation (EF)", "R3D", "MC3"], matplotlib.colors.TABLEAU_COLORS):
